...
function arter_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'		=> 'arter-plugin',
			'source'	=> ARTER_EXTRA_PLUGINS_DIRECTORY . 'normal/arter-plugin/270724/' . 'arter-plugin.zip',
			'required'	=> true,
			'version'	=> '1.8.1',
		),
	...
	if ( class_exists( 'ArterPlugin' ) ) {
		$plugins[] = array(
			...
			'source'				=> ARTER_EXTRA_PLUGINS_DIRECTORY . 'normal/acf/270724/' . 'advanced-custom-fields-pro.zip',
			'required'				=> true,
			'version'				=> '6.3.4',
		);
	}
